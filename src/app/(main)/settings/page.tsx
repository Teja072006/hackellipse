  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      <header className="mb-8">
        ...
        <p className="text-lg text-muted-foreground mt-1">Manage your account and application preferences.</p>
      </header>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input id="displayName" defaultValue="Current User Name" className="input-glow-focus" />
              </div>
              <div>
                <Label htmlFor="email">Email Address</Label>
                <Input id="email" type="email" defaultValue="user@example.com" disabled className="input-glow-focus" />
              </div>
            </div>
            <div>
              <Label htmlFor="bio">Short Bio</Label>
              <Input id="bio" placeholder="Tell us about yourself" className="input-glow-focus" />
            </div>
        ...
        <Card className="bg-card shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Control how you receive notifications from SkillSmith.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="inAppNotifications" className="flex flex-col space-y-1">
                ...
                <span className="font-normal leading-snug text-muted-foreground">
                  Get notified directly within the SkillSmith platform.
                </span>
              </Label>
        ...
        <Card className="bg-card shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Customize the look and feel of SkillSmith (Theme options coming soon).</CardDescription>
          </CardHeader>
          <CardContent>
